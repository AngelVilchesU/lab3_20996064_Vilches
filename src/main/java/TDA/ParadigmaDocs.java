...
public class ParadigmaDocs {
    ...
    public boolean register(String nombreUsuario, String contraseniaUsuario){
        ...
        usuarioNuevo.Usuario(nombreUsuario, contraseniaUsuario, fechaCreacion, sesion);
    ...
    public boolean logout(){
        ...
        for(i = 0; i < listaUsuarios.size(); i ++){
            if(esUsuarioActivo(listaUsuarios.get(i))){
                ...
                usuarioFinalizado.Usuario(listaUsuarios.get(i).getNombreUsuario(), listaUsuarios.get(i).getContraseniaUsuario(), listaUsuarios.get(i).getFechaCreacion(), sesionInactiva);
     ...
     * de modo que se evalua la existencia de un usuario activo para, considerando los parametros de
     * entrada ingresados por pantalla, crear el documento indicado. En caso de no existir usuario
     ...
     * a un usuario registrado en la plataforma de modo que se evalua la existencia de un usuario activo
     ...
     * documento en la plataforma u editor de modo que se evalua la existencia de un usuario activo
     ...
     * condicion, el contenido no es adicionado al documento.
     ...
     * u editor de modo que se evalua la existencia de un usuario activo el cual a su vez sea autor del documento
     * a trabajar para, considerando los parametros de entrada ingresados por pantalla, buscar el documento a trabajar
     * junto con su correspondiente version a restaurar (si existe) e "intercambiar" la posicion de la version actual
     * y version a restaurar para luego corregir los identificadores internos de las versiones para que estas
     * sean correlativas una vez efectuado el cambio.
     ...
     * activo el cual a su vez sea autor del documento a trabajar para, considerando los parametros de entrada ingresados
     * por pantalla, buscar el documento a trabajar y, una vez encontrado (en caso de existir) remover todo el contenido
     * referente a accesos del mismo.
     ...
     * activo, luego considerando los parametros de entrada ingresados por pantalla, se buscan el/los documento
     ...
     * dichas condiciones, del texto a buscar ingresado en el contenido de todas las versiones de dicho documento
